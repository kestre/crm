        ...
        <form class="layui-form" style="width:80%;">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" lay-verify="required" name="ceo" value="${(customer.ceo)!}" placeholder="请输入法人">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="cusCredit" value="${(customer.cusCredit)!}" placeholder="请输入信用度">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="number" class="layui-input" name="regCapital" value="${(customer.regCapital)!}" placeholder="请输入注册资金">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="accountBank" value="${(customer.accountBank)!}" placeholder="请输入开户行">
                    </div>

                    <label class="layui-form-label">开户账号</label>
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="account" value="${(customer.account)!}" placeholder="请输入开户账号">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="annualSaleVolume" value="${(customer.annualSaleVolume)!}" placeholder="请输入年营业额">
                    </div>
                </div>
            </div>
