        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                ...
                <dl class="layui-nav-child">
                    ...
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${crm}/user/toPasswordPage" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                    </dd>
                    <dd>
                        ...
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-flag"></i><span class="layui-left-nav"> 客户管理</span> <span class="layui-nav-more"></span></a><dl class="layui-nav-child">
                                ...
                                <#if permissions?seq_contains("2020")>
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-4" data-tab="loss/index" target="_self"><i class="fa fa-user-times"></i><span class="layui-left-nav"> 客户流失管理</span></a>
                                    </dd>
                                </#if>
                            </dl>
                        </li>
