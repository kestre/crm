...
<form class="layui-form" style="width:80%;">
	...
	<input id="id" name="state" type="hidden" value="fw_003"/>
	<#--assignMan隐藏域-->
	...
	<div class="layui-from-item layui-row">
		<label class="layui-form-label">服务处理</label>
		<div class="layui-input-block">
			<textarea name="serviceProce" id="serviceProce" class="layui-textarea"></textarea>
		</div>
	</div>
...
<script type="text/javascript" src="js/customerServe/customerServeProceAdd.js"></script>
</body>
</html>